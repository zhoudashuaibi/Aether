...
export type ProviderType = 'command_code' | 'custom' | 'claude_code' | 'codex' | 'chatgpt_web' | 'gemini_cli' | 'antigravity' | 'kiro' | 'grok' | 'xai' | 'windsurf' | 'vertex_ai'
...
export interface ProviderWithEndpointsSummary {
  ...
  simulated_cache_min_hit_percentage?: number
  simulated_cache_max_hit_percentage?: number
